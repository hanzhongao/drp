        ...
        s.setPath('https://dup.baidustatic.com/'), s.define({
            ...
            processFrameData: function (t) {
                ...
                if (c) e = c; else if (t.isPdbAd) {
                    ...
                    n = 'onload="' + this.config.DUP_PREFIX + "floatShow('" + i.location + "','" + m + "', this);\"", e = this.param.getPmpRequestUrl(t)
            ...
            processSlotInfo: function (t) {
                ...
                return r.locationType = a, r.containerId = t.containerId, r.closeType = i.closeType, r.floatingState = this.getFloatingState(t, a), r
            },
            parseHtmlSnippet: function (t) {
            ...
            parseCloseBtnLayoutData: function (t) {
                ...
                var s = {domId: t.containerId, borderRadius: e, top: n, btnTag: i, lineHeight: o};
                return s
            },
            parseCloseButtonHtml: function (t) {
                var e = ["<div", ' class="closeBtn"', ' style="', "position:absolute;", "left:50%;", "top:{top}px;", "margin-left: -20px;", "width:40px;", "height:20px;", "background-color:#4a4a4a;", "cursor:pointer;", "border-radius:{borderRadius};", "z-index:2147483647;", "color:#ffffff;", "font-weight:600;", "box-sizing:border-box;", "font-size:14px;", 'line-height:{lineHeight};">', "{btnTag}", "</div>"].join(""),
            ...
            decorateContainer: function (t, e) {
                ...
                var o = 2 === e.locationType ? "top" : "bottom",
                    s = 2 === e.locationType ? "border-bottom" : "border-top", r = t.style;
                r.cssText = ["box-sizing: content-box;", "display:block", "position:" + n, "z-index:2147483647;", "left:0", o + ":" + i + "px", "background-color:" + e.backgroundColor, "opacity:" + e.backgroundOpacity, "text-align:center", "width:" + e.width + "px", "height:" + e.height + "px", s + ":2px solid #4a4a4a"].join(";")
            },
            ...
            closeBtnOnClickHandler: function (t, e, i, n) {
                var o = 2 === e.locationType ? "top" : "bottom";
                if ("hidden" === i.getAttribute("state") ? this.showAdContainer(o, i, n) : this.hideAdContainer(o, i, n), 2 === t.closeType) {
            ...
            hideAdContainer: function (t, e, i) {
                ...
                n = n && parseInt(n, 10), e.style.transition = t + " 0.75s", e.style["-webkit-transition"] = t + " 0.75s", e.style["-moz-transition"] = t + " 0.75s", e.style["-o-transition"] = t + " 0.75s", e.style[t] = -1 * n + "px", "top" === t ? (i.style.lineHeight = this.downArrawLineHeight, i.innerText = this.downArraw) : (i.style.lineHeight = this.upArrawLineHeight,
                    i.innerText = this.upArraw)
            },
            validate: function (t) {
            ...
            render: function (t) {
                ...
                if (this.validate(e)) {
                    ...
                    if (!i && n && this.containerFilter(t, e)) {
                        ...
                        var r = {closeBtnHtml: o, iframeHtml: this.frame.getFrameHTML(t)}, a = this.parseHtmlSnippet(r);
                        n.innerHTML = a;
                        ...
                        if (d) {
                            ...
                            this.dom.bind(d, "click", function () {
                                var i = this;
                                l.closeBtnOnClickHandler(t, e, n, i)
                            })
                        }
                        this.hiddenFloatAd.render(t), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH)
                    }
                }
            },
            showFloatAd: function (t, e, i) {
                ...
                if (document.body && n) {
                    ...
                    t = "2" === t ? "top" : "bottom", this.dom.bind(document.body, "touchstart", s.proxy(this, this.touchStart)), this.dom.bind(document.body, "touchend", s.proxy(this, this.touchEnd, n, o, t, e))
                }
            },
            ...
            touchEnd: function (t, e, i, n, o) {
                ...
                var s = this.pageY - this.startY;
                (-10 > s && !this[n] && o === this.upSlideAnimation || s > 10 && !this[n] && o === this.downSlideAnimation) && (this[n] = !0, this.showAdContainer(n, e, i))
            },
            ...
            name: "main", namespace: "dup.ui.delivery", deps: {
                config: "dup.common.config",
                slot: "dup.business.slot",
                fingerPrint: "dup.business.fingerPrint",
                data: "dup.common.utility.data",
