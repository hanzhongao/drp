            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <ul>
                        ...
                        <li><a href="pages/front/news/news_show.action"><span class="glyphicon glyphicon-exclamation-sign text-danger"></span>&nbsp;【2010-10-10】${news.title}</a></li>
                        </c:forEach>
                    </ul>
                </div>
                <div class="panel-footer text-right">
                    <a href="pages/front/news/news_list_front.action">
