    ...
    <div class="content-wrapper text-left">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="<%=EMP_ADD_URL%>" id="myform" method="post"
                            ...
                            <div class="col-md-5">
                                <select id="did" name="did" class="form-control">
                                    ...
                                    <c:forEach items="${allDepts}" var="dept">
                                        <option value="${dept.did}" name="did">${dept.dname}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <!-- 定义表单错误提示显示元素 -->
                            ...
                            <div class="col-md-5">
                                <select id="lid" name="lid" class="form-control">
                                    ...
                                    <c:forEach items="${allLevels}" var="level">
                                        <option value="${level.lid}" name="lid">${level.title}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <!-- 定义表单错误提示显示元素 -->
