            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed">
                    ...
                    <c:forEach items="${allMembers}" var="member">
                        <tr>
                            <td class="text-center"><input type="checkbox" id="eid-1" name="eid-1" value="1"></td>
                            <td class="text-center">
                                <img src="http://upload-server/upload/${member.photo}" style="width:20px;"/>
                            </td>
                            <td class="text-center">${member.name}</td>
                            <td class="text-center">${allLevels.get(member.lid)}</td>
                            <td class="text-center">${allDepts.get(member.did)}</td>
                            ...
                            <td class="text-center">
                                ...
                                <a type="button" class="btn btn-warning btn-xs"
                                   href="<%=EMP_EDIT_URL%>?mid=${member.mid}">
