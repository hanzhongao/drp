...
<%!
	...
	public static final String NEWS_EDIT_URL = "pages/back/admin/news/news_edit_pre.action" ;
%>
</head>
		...
		<div class="content-wrapper">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<table class="table table-hover">
						...
						<tr id="news-${news.nid}">
							...
							<c:if test="${news.status==1}">
								<td class="text-center" id="${news.nid}">已发布</td>
							</c:if>
					...
					<a  id="addBtn" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;发布公告</a>
