	...
	<div class="content-wrapper">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form action="<%=NEWS_EDIT_URL%>?photo=${news.photo}" id="myform" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group" id="titleDiv">
						<label class="col-md-2 control-label" for="title">公告标题：</label>
						<div class="col-md-5">
							<input type="text" name="title" id="title" class="form-control input-sm" placeholder="请输入公告标题" value="${news.title}">
						</div>
					...
					<div class="form-group" id="absDiv">
						...
						<div class="col-md-5">
							<input type="text" name="abs" id="abs" class="form-control input-sm" placeholder="请输入公告摘要" value="${news.abs}">
						</div>
					...
					<div class="form-group" id="picDiv">
						...
						<div class="col-md-5">
							<input type="file" name="photo" id="photo" class="form-control input-sm" placeholder="请选择公告所需要的图片" value="${news.photo}">
						</div>
					...
					<div class="form-group">
						<div class="col-md-offset-2 col-md-5">
							...
							<input type="hidden" name="pic" id="pic" value="${news.photo}">
