					...
					<div>
						<table class="table table-condensed" >
							...
							<tr>
								...
								<td rowspan="7"><img src="http://upload-server/upload/${good.photo==""?"nophoto.jpg":good.photo}" style="height:300px;"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><pre class="pre-scrollable" style="width:700px;height:150px;">${good.note}</pre></td>
							</tr>
						</table>
					</div>
