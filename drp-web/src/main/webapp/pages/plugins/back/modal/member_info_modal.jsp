						...
						<div class="col-xs-8">
							<table class="table table-condensed" style="width:700px;">
								<tr >
									...
									<td><span id="name">老张</span></td>
								</tr>
								<tr>
									<td><strong>雇员职位：</strong></td>
									<td id="level_title">普通员工</td>
								</tr>
								<tr>
									<td><strong>所属部门：</strong></td>
									<td id="dept_dname">技术部</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><pre class="pre-scrollable" style="width:450px;height:150px;" id="note">发神经阿德里飞洒抵抗力 范德克鲁斯建立开放撒 方力申搭建了开发商的 发动机萨拉空间来看 234uop富士达会计分录款手机范德萨进来进来看范德萨克利夫兰斯顿卡机了开发商大量了快捷方式的拉开建立开放撒酒 刘嘉玲发撒旦机立刻地方撒刻录机弗拉基反抗螺丝钉</pre></td>
								</tr>
							</table>
						</div>
					</div>
