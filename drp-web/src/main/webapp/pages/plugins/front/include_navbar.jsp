    ...
    <nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    class="glyphicon glyphicon-globe"></span>&nbsp;个人中心<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="divider">&nbsp;</li>
                    <li><a href="<%=PURCHASE_ADD_URL%>"><span class="glyphicon glyphicon-certificate"></span>&nbsp;大宗采购</a>
                    </li>
                </ul>
            </li>
            <%
        ...
        <form class="navbar-form navbar-left" action="" method="post">
            <div class="form-group">
                <input type="text" class="form-control input-xs" placeholder="请输入商品关键字..."
                       style="width:300px;background: #F5F5F5;height:30px;">
